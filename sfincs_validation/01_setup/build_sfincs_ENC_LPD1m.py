...
#os.chdir(r'Z:\users\lelise\projects\Carolinas\Chapter1\sfincs\2018_Florence\mod_v5\carolinas_200m_sbg5m_v2\model_scenarios')
os.chdir('/projects/sfincs/')
root = 'flo_hindcast_v6_200m_LPD1m_avgN'
mod = SfincsModel(root=root, mode='w+', data_libs=yml)
...
datasets_dep = [
    ...
    {"elevtn": "nhd_area_peedee_1mburn", 'reproj_method': 'bilinear'},
